...
var sequel = "The Alchemist 2: Electric Boogaloo";
...
if (isFavorite === true) {
  console.log(`My favorite book title is ${title} !`)
} else {
...
var books = ["The Alchemist", "The Road", "The Green Mile", "Harry Potter", "Dantes Inferno"];
